...
Set the color of a spinner - accepts [Bootstrap utility classes](docs/styles/styles-folder?utilities) or [CSS Hex colors](https://www.w3schools.com/cssref/css_colors_legal.asp) as a string. This does not support named CSS colors or rgb(a) values.
...
We recommend using [Bootstrap utility classes](docs/styles/styles-folder?utilities) for consistent colors before resorting to CSS Hex colors. The default theme for Interstate includes the following color mappings:
