...
<Story name="Headings">
  <div className='space-y-8 prism-base'>
      <hgroup className='space-y-4'>
        <Tooltip content="welcome to prism" className='prism-heading-1'>h1 - Heading One</Tooltip>
      ...
      <div className="flex">
        <div>
          <div className="prism prism-form-check">
            <input className="prism prism-form-check-input prism-form-radio appearance-none  bg-white  transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="flexRadioDefault" id="flexRadioDefault1" />
            <label className="prism prism-label prism-form-check-label inline-block" for="flexRadioDefault1">
              Default radio
            </label>
          </div>
          <div className="prism-form-check">
            <input className="prism-form-check-input prism-form-radio  bg-white transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked />
            <label className=" prism-label prism-form-check-label inline-block" for="flexRadioDefault2">
              Default checked radio
            </label>
          </div>
           <div className="prism-form-check">
            <input  type="checkbox" className="prism  prism-form-check-input prism-form-checkbox appearance-none  transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" name="flexRadioDefault" id="flexRadioDefault2"  />
            <label className="prism-label prism-form-check-label inline-block" for="flexRadioDefault2">
              Default Checkbox
            </label>
          </div>
           <div className="prism-form-check">
            <input type="checkbox" className="prism prism-form-check-input prism-form-checkbox appearance-none    transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"  name="flexRadioDefault" id="flexRadioDefault2" checked />
            <label  className=" prism-label prism-form-check-label inline-block" for="flexRadioDefault2">
            Default Checkbox
            </label>
          </div>
