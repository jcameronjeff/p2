import { Meta, Primary, Canvas, Story } from "@storybook/blocks";
import { Avatar, Button, Tooltip, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6, Caption, Label, Banner, Box } from '../lib';
import { SpinnerIcon } from '@prism2/icons-react';
import { DocumentTextIcon } from '@prism2/icons-react/24/solid'

<Meta title="Components/HTML5" />
...
<Canvas>
  <Story name='Forms'>
    ...
    <label htmlFor="example-input-email" className='prism-label'>
      Email address
      <input className='prism-text-input' type="email" id="example-input-email" placeholder="Enter email" />
    </label>
    <label htmlFor="example-input-email" className='prism-form-control'>
      Inline Form
