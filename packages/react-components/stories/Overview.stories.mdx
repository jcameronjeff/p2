...
import { Modal, Combobox } from '../lib';
import { Template as ModalTemplate } from '../lib/Modal/Modal.stories';
...
<Canvas>
  <Story id='interaction-combobox--basic-usage' />
</Canvas>

## Login Prompt

<Canvas>
  <Story id='interaction-loginprompt--basic' />
</Canvas>
