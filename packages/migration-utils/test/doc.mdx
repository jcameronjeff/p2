...
import { Icon } from '@prism/library';
import { SandboxDemo } from '@site/src/components';
...
| ---------------- | ---------- | ------------------------- | ----------------------
| `className`        | `string`   | `null`                  | The classes "icon" and a prefixed "prism-icon-" icon class name are required
