...
---
## Related Components
 - [Menu](https://interstate-staging.awsgdmshednp.manheim.com/docs/components/navigation-components/menu): Menu have actions
 - Split Button: *component coming soon*
## Sizes
...
Buttons are normally aligned to the right with the primary action on the far right. When we have a pair of buttons, such as submit and cancel, we have a 16px gap when the buttons are horizontal, or 8px gap when they are vertical.
