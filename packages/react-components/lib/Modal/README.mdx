...
The Modal variant should only be used to display brief content and simple interactions such as an acknowledgement (e.g. “Okay”) or confirmation (e.g. “Submit” vs “Cancel”).

Use the Modal variant to display slightly longer content or short forms such as an address entry form.

Use a Slideout variant for the most complex content and interactions. Slidouts can vary in width to accomodate a variety of content layouts.
