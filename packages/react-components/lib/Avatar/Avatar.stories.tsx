...
const SizingTemplate: ComponentStory<typeof Avatar> = () => {
  return (
    <div className='container w-[800px] gap-2 flex justify-center items-center flex-wrap'>
      <Avatar name='James Cameron' src={imgUrls[0]} />
      <Avatar name='James Cameron' src={imgUrls[1]} className='h-16 w-16' />
      <Avatar name='James Cameron' src={imgUrls[2]} className='!h-20 !w-20' />
      <Avatar name='James Cameron' src={imgUrls[3]} className='h-24 w-24' />
    </div>
  );
