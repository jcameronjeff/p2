const theme = {
  ...
  accentColor: {
    ...
    gray: {
      ...
      300: "rgba(178, 178, 178, 1)",
      400: "rgba(153, 153, 153, 1)",
      500: "rgba(130, 130, 130, 1)",
      600: "rgba(109, 109, 109, 1)",
      700: "rgba(90, 90, 90, 1)",
      800: "rgba(74, 74, 74, 1)",
      900: "rgba(51, 51, 51, 1)",
    },
    ...
    red: {
      50: "rgba(255, 234, 231, 1)",
      100: "rgba(255, 214, 207, 1)",
      200: "rgba(255, 182, 170, 1)",
      300: "rgba(249, 147, 132, 1)",
      400: "rgba(240, 111, 97, 1)",
      500: "rgba(228, 73, 65, 1)",
      600: "rgba(212, 30, 39, 1)",
      700: "rgba(177, 29, 35, 1)",
      800: "rgba(148, 20, 27, 1)",
      900: "rgba(111, 0, 0, 1)",
    },
    orange: {
      50: "rgba(255, 240, 230, 1)",
      100: "rgba(255, 219, 195, 1)",
      200: "rgba(255, 189, 147, 1)",
      300: "rgba(255, 153, 90, 1)",
      400: "rgba(248, 114, 22, 1)",
      500: "rgba(210, 98, 23, 1)",
      600: "rgba(176, 84, 23, 1)",
      700: "rgba(146, 71, 25, 1)",
      800: "rgba(119, 58, 21, 1)",
      900: "rgba(81, 41, 18, 1)",
    },
    amber: {
    ...
    yellow: {
      50: "rgba(255, 247, 224, 1)",
      100: "rgba(255, 240, 194, 1)",
      200: "rgba(255, 230, 153, 1)",
      300: "rgba(255, 217, 102, 1)",
      400: "rgba(255, 194, 14, 1)",
      500: "rgba(235, 176, 0, 1)",
      600: "rgba(179, 134, 0, 1)",
      700: "rgba(143, 107, 0, 1)",
      800: "rgba(102, 77, 0, 1)",
      900: "rgba(77, 57, 0, 1)",
    },
    lime: {
    ...
    green: {
      50: "rgba(233, 246, 229, 1)",
      100: "rgba(201, 234, 191, 1)",
      200: "rgba(159, 218, 142, 1)",
      300: "rgba(108, 198, 81, 1)",
      400: "rgba(83, 172, 57, 1)",
      500: "rgba(71, 146, 48, 1)",
      600: "rgba(60, 123, 41, 1)",
      700: "rgba(50, 102, 34, 1)",
      800: "rgba(40, 84, 26, 1)",
      900: "rgba(32, 58, 23, 1)",
    },
    emerald: {
    ...
    blue: {
      50: "rgba(235, 246, 255, 1)",
      100: "rgba(204, 232, 255, 1)",
      200: "rgba(163, 208, 245, 1)",
      300: "rgba(129, 183, 228, 1)",
      400: "rgba(87, 160, 219, 1)",
      500: "rgba(49, 138, 211, 1)",
      600: "rgba(35, 114, 184, 1)",
      700: "rgba(0, 91, 168, 1)",
      800: "rgba(0, 73, 134, 1)",
      900: "rgba(0, 52, 104, 1)",
      1000: "rgba(0, 27, 53, 1)",
    ...
    fuchsia: {
      50: "rgba(252, 241, 247, 1)",
      100: "rgba(248, 218, 235, 1)",
      200: "rgba(242, 189, 219, 1)",
      300: "rgba(235, 154, 200, 1)",
      400: "rgba(228, 116, 178, 1)",
      500: "rgba(220, 74, 155, 1)",
      600: "rgba(202, 39, 128, 1)",
      700: "rgba(169, 33, 106, 1)",
      800: "rgba(140, 29, 88, 1)",
      900: "rgba(98, 19, 61, 1)",
    },
    pink: {
    ...
    surface: {
      ...
      subtle: "rgba(244, 244, 244, 1)",
      muted: "rgba(227, 227, 227, 1)",
      invert: "rgba(74, 74, 74, 1)",
    },
    fg: {
      DEFAULT: "rgba(51, 51, 51, 1)",
      strong: "rgba(0, 0, 0, 1)",
      subtle: "rgba(109, 109, 109, 1)",
      muted: "rgba(153, 153, 153, 1)",
      invert: "rgba(255, 255, 255, 1)",
    },
    text: {
      label: "rgba(109, 109, 109, 1)",
      placeholder: "rgba(178, 178, 178, 1)",
      disabled: "rgba(153, 153, 153, 1)",
      body: "rgba(51, 51, 51, 1)",
      headings: "rgba(0, 0, 0, 1)",
      link: "rgba(0, 91, 168, 1)",
      visited: "rgba(169, 33, 106, 1)",
    },
    accent: {
      DEFAULT: "rgba(0, 91, 168, 1)",
      onAccent: "rgba(255, 255, 255, 1)",
      bg: "rgba(235, 246, 255, 1)",
      invert: "rgba(0, 52, 104, 1)",
    },
    success: {
      DEFAULT: "rgba(60, 123, 41, 1)",
      onSuccess: "rgba(255, 255, 255, 1)",
      bg: "rgba(233, 246, 229, 1)",
      invert: "rgba(40, 84, 26, 1)",
    },
    warning: {
      DEFAULT: "rgba(235, 176, 0, 1)",
      onWarning: "rgba(0, 0, 0, 1)",
      bg: "rgba(255, 247, 224, 1)",
      invert: "rgba(102, 77, 0, 1)",
    },
    info: {
      DEFAULT: "rgba(49, 138, 211, 1)",
      onInfo: "rgba(255, 255, 255, 1)",
      bg: "rgba(204, 232, 255, 1)",
      invert: "rgba(0, 73, 134, 1)",
    },
    danger: {
      DEFAULT: "rgba(228, 73, 65, 1)",
      onDanger: "rgba(255, 255, 255, 1)",
      bg: "rgba(255, 234, 231, 1)",
      invert: "rgba(148, 20, 27, 1)",
    },
    borderColor: {
      DEFAULT: "rgba(178, 178, 178, 1)",
      focus: "rgba(49, 138, 211, 1)",
    },
    auto: "auto",
  },
  animation: {
  ...
  backgroundColor: {
    ...
    surface: {
      ...
      muted: "rgba(227, 227, 227, 1)",
      invert: "rgba(74, 74, 74, 1)",
      active: "rgba(235, 246, 255, 1)",
      selected: "rgba(0, 52, 104, 1)",
      disabled: "rgba(244, 244, 244, 1)",
    },
    fg: {
      DEFAULT: "rgba(51, 51, 51, 1)",
      strong: "rgba(0, 0, 0, 1)",
    ...
    accent: {
      ...
      bg: "rgba(235, 246, 255, 1)",
      invert: "rgba(0, 52, 104, 1)",
      light: "rgba(235, 246, 255, 1)",
      dark: "rgba(0, 52, 104, 1)",
    },
    success: {
      DEFAULT: "rgba(60, 123, 41, 1)",
      onSuccess: "rgba(255, 255, 255, 1)",
  ...
  boxShadow: {
    ...
    "shadow-xl": {
      ...
      comment: "For left and right Slideouts",
      extensions: {
        "org.lukasoppermann.figmaDesignTokens": {
          styleId: "S:ad698aa48a08357a89c9e4d63b6adf0ea8f99030,",
          exportKey: "effect",
        },
      },
    },
  ...
  border: {
    ...
    focus: {
      color: "rgba(49, 138, 211, 1)",
      width: "2px",
      style: "solid",
    },
    error: {
      color: "rgba(228, 73, 65, 1)",
      width: "2px",
      style: "solid",
    },
  },
