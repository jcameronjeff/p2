...
## Getting Started with the Interstate Design System

Interstate is the design system for Cox Automotive retail and wholesale solutions. It elevates our client experience, empowers UX creativity, ensures our client and team member experiences clear, efficient, and feel like one Cox Auto. and ultimately delivers greater alignment and cohesion across our products. Interstate will debut in public via Retail360. 

## Using Interstate 

The Interstate Design System is organized into sections to help you understand the principles and guidelines that form the basis of how you can build, iterate, and evolve products with Interstate. These sections are: 

[Foundation](https://interstate-staging.awsgdmshednp.manheim.com/docs/foundation/accessibility): inform the basis of any great user interface with defining guidance around page grid and layout, and supports the accessibility standards to the shared language that guides how we build high-quality experiences. 

[Styles](https://interstate-staging.awsgdmshednp.manheim.com/docs/styles/): the visual aspects of a UI that give it a distinct look and feel.  

[Components](https://interstate-staging.awsgdmshednp.manheim.com/docs/components/): the building blocks for creating a user interface, organized into categories based on their purpose. 

[Design Patterns](https://interstate-staging.awsgdmshednp.manheim.com/docs/design-patterns/): guidance for supporting common user actions, tasks, and experiences. 

## Design resources 
- [Interstate Patterns Library] *Link coming soon*
- [Interstate Components Library](https://www.figma.com/file/pVLFYATX2AsJtrcn3pdNX8/%F0%9F%A7%B0-Interstate-DS?type=design&node-id=7%3A50&mode=design&t=Msn9cVBiaBpOnWNU-1)

## Development resources 
- React  *link coming soon*
- [Tokens](https://interstate-staging.awsgdmshednp.manheim.com/docs/tokens/)

 ## Get support 
- For general questions, feedback, or support for InterstateFigma, InterstateReact, InterstateStyles, and InterstateTokens, visit our Slack channel [#interstate-ds-community](https://coxauto.slack.com/archives/C0548P23UPJ). 
- For questions about InterstateReact delivery, contact Seb Dufourmantelle at [sebastien.dufourmantelle2@coxautoinc.com](mailto:sebastien.dufourmantelle2@coxautoinc.com) 
- For questions about InterstateStyles delivery, contact Clay Elrod at [clay.elrod@coxautoinc.com](mailto:clay.elrod@coxautoinc.com)
- For questions about Retail360 / 2023 Interstate integrations contact Jesse Kates at [jesse.kates@coxautoinc.com](mailto:jesse.kates@coxautoinc.com)

For general support discussions use the [#interstate-ds-support](https://coxauto.slack.com/archives/C04B2TF5FFU).

## Interstate timeline 

To deliver on its promise, Interstate will provide guidelines, tooling, and practices. 

- This documentation site will be launched in 2023Q3 to provide easy access to Interstate information for product team members. This includes guidelines, usage information, patterns, etc. 
- As of 2023Q2, the following tools are available in beta for use in Retail360: 
 - InterstateFigma: a Figma library for web application design 
 - InterstateReact – a component library for React-based web applications 
 - InterstateStyles – a Tailwind-powered utility library for web applications and web components 
 - InterstateTokens – a solution to share design tokens to any implementation
- Products adopting Interstate will be evaluated to identify improvements to the design system and optimize the integration process. In addition, product design teams will work closely with the Interstate Governance Team to review work, identify other improvements needed, and ensure compliance. 

The Interstate team is currently working with Product leadership to prioritize products that will adopt Interstate after Retail360.  

If you’re eager to adopt Interstate or want to understand the impact of Interstate on your product ahead of this prioritization, please reach out to [Jon Ferry](mailto:jonathan.ferry@coxautoinc.com).  


***
**The remaining section of this page is under construction, please check back in August**
